...
export const en: TranslationKeys = {
	...
	chatScreen: {
		...
		statusExecutingTools: 'Executing tools...',
		statusWaitingRetry: 'Waiting for retry...',
		...
		statusPressEscToInterrupt: 'Press Esc to interrupt',
		statusSubAgentLabel: 'sub-agent: {agentName}',
		statusSubAgentLabelWithEvent: 'sub-agent: {agentName} ({eventType})',

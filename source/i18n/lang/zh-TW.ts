...
export const zhTW: TranslationKeys = {
	...
	chatScreen: {
		...
		statusWriting: '輸出中...',
		statusExecutingTools: '執行工具中...',
		statusWaitingRetry: '等待重試中...',
		statusFinalizing: '收尾處理中...',
		...
		statusPressEscToInterrupt: '按 Esc 中斷',
		statusSubAgentLabel: '子代理: {agentName}',
		statusSubAgentLabelWithEvent: '子代理: {agentName} ({eventType})',
